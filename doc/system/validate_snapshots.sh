...
ASSEMBLED_OUTPUT="${1:-$ROOT_DIR/doc/DFLSYSTEM.md}"
...
require_contains "$PARTS_DIR/_index.md" "Primary output: \`doc/DFLSYSTEM.md\`" "index primary output"
...
require_contains "$ASSEMBLED_OUTPUT" "Primary output: \`doc/DFLSYSTEM.md\`" "assembled primary output"
